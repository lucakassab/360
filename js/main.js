...
function setupOrbitControls() {
  // quando a cena terminar de renderizar, injeta o OrbitControls
  scene.addEventListener('renderstart', () => {
    ...
    ctrl.minPolarAngle = 0;           // permite olhar pra cima em mobile
    ctrl.maxPolarAngle = Math.PI;     // permite olhar pra baixo também

    // sem damping, não precisa chamar update a cada frame
  });
}
...
async function init() {
  ...
  // dispara OrbitControls
  setupOrbitControls();

  // VR handlers continuam iguais
